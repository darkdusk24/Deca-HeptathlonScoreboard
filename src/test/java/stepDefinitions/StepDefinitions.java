...
public class StepDefinitions {
	...
	public void i_can_assign_a_score_to_the_competitor(double score) {
		assertEquals(score, competitor.AssignScore(score), 0);
	}
	...
	public void i_can_then_view_the_name_sportsEvent_score(String name, String sportsEvent, double score) {
		...
		if (name.equalsIgnoreCase("calvin") && sportsEvent.equalsIgnoreCase("110mH") && (score == 900)) {
